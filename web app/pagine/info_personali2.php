...
<ul class="list-group">
        ...
        <li class="list-group-item">
            <?php
                echo "Carica accademica: ".$row['carica'];
            ?>
        </li>
        <li class="list-group-item">
            <?php
        ...
        <li class="list-group-item">
            <?php
                echo "Nome corso di laurea: ".$row['laurea'];
            ?>
        </li>
        <li class="list-group-item">
            <?php
                echo "Numero insegnamenti di cui è responsabile: ".$row['numero_insegnamenti'];
            ?>
        </li>
    </ul>
